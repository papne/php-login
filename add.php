...
// mysqli_select_db("xkelnren_test") or die(mysql_error()); 
...
$check = mysqli_query($db_test, "SELECT username FROM users WHERE username = '$usercheck'");
...
$add_member = mysqli_query($db_test, $insert);
?>
