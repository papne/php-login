...
$conect = mysqli_connect("localhost","xkelnren_test","PwdTest", "xkelnren_test") or die(mysql_error()); 
...
while($info = mysqli_fetch_array( $check )){
	...
	//gives error if the password is wrong
 	if ($_POST['pass'] != $info['password']){
		...
		$hour = time() + 3600; 
		setcookie("XKels_cookie", $_POST['username'], $hour); 
		setcookie("XKels_key", $_POST['pass'], $hour);	 
